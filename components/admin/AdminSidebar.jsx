...
const AdminSidebar = () => {
    ...
    // TODO: Replace with Firebase Auth user info
    return (
        <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
            <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
                {/* Replace with Firebase user photo or fallback to logo */}
                <Image className="w-14 h-14 rounded-full" src={require("../../assets/Asset11.png")} alt="Admin Logo" width={80} height={80} />
